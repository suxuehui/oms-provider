 ...
 */
@Component
public class Edb_36_OrderTimeTask {
	
	private static final Logger logger = Logger.getLogger(Edb_36_OrderTimeTask.class);
	
	@Resource
	private Edb_36_OrderService order_36_Service;
...
//			}else{
				...
				String[] str_date=DateUtilTool.dateDiff("2016-10-13 00:00:00","2016-10-14 12:00:00",new Integer(60).intValue());
				...
				for (int i = 0; i < str_date.length; i++) {
					...
					order_36_Service.dealOrder_TradesSoldGetResponse(str,multiChannelOrderBatch);
				} 
