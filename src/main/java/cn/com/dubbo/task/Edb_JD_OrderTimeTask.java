 ...
 */
@Component
public class Edb_JD_OrderTimeTask {
	
	private static final Logger logger = Logger.getLogger(Edb_JD_OrderTimeTask.class);
	
	@Resource
	private Edb_JD_OrderService jd_orderService;
...
//			}else{
				...
				String[] str_date=DateUtilTool.dateDiff("2016-10-13 00:00:00","2016-10-14 10:00:00",new Integer(60).intValue());
				...
				for (int i = 0; i < str_date.length; i++) {
					...
					jd_orderService.dealOrder_TradesSoldGetResponse(str,multiChannelOrderBatch);
				}
