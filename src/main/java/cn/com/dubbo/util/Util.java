...
public class Util {
	...
	public static String md5Signature(TreeMap<String, String> params, String secret, String token) {

		String result = null;

		StringBuffer orgin = getBeforeSign(params, new StringBuffer(secret + token));
